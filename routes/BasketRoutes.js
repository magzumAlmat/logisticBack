...
const BasketCarNumber = require("../models/BasketCarNumber");
const ProposalBasketLocalExpenses = require("../models/ProposalBasketLocalExpenses");
const ProposalBasketStockStatus = require("../models/ProposalBasketStockStatus");
...
router.post("/", auth, async (req, res) => {
  try {
    ...
    const total_volume = proposals
      .reduce(
        (acc, proposal) => acc.plus(new Decimal(proposal.actual_volume)),
        new Decimal(0)
      )
      .toFixed(2);
