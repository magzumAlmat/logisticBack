...
const convertCommasToDots = require("../utils/convertCommasToDots");
const Company = require("../models/Company");
const Proposal = require("../models/Proposal");
// const ProposalBasket = require("../models/ProposalBasket");
const ProposalLocalExpenses = require("../models/ProposalLocalExpenses");
...
const createLocalExpense = async (req, res) => {
  try {
    const decimal_price = convertCommasToDots(req.body.price);
