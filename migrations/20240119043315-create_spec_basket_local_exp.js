module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable("SpecProposalBasketLocalExpenses", {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
    ...
    await queryInterface.addConstraint("SpecProposalBasketLocalExpenses", {
  ...
  down: async (queryInterface) => {
    await queryInterface.dropTable("SpecProposalBasketLocalExpenses");
  },
};
